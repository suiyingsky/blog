...
module.exports = {
  ...
  base: '/vuepress-blog/', // '/<github仓库名>/'， 默认'/'
  ...
  themeConfig: { // 主题配置
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'suiyingsky | <a href="https://suiyingsky.github.io/vuepress-blog/" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    }
  },
  plugins: [ // 插件
    ...
    [
      ...
      {
        hm: '16116e93c3e7355eefa14953466eb48e'
      }
    ],
    [
      ...
      // },
      {
        choosen: 'gitalk',
        options: {
          clientID: '023836463bbb8898fcf9',
          clientSecret: '405fe57c739d3fdcaad3fcb35ab8f487b7bb4494',
          repo: 'vuepress-blog', // GitHub 仓库
          owner: 'suiyingsky', // GitHub仓库所有者
          admin: ['suiyingsky'], // 对仓库有写权限的人
